// HISTORY / TRENDS — week + month bar charts, records

function HistoryScreen({ tweaks, theme, nav }) {
  ...
  return (
    <div data-screen-label="03 History" style={{
      ...
      <div style={{ padding: '0 22px 14px' }}>
        <div style={{ ...TYPE.sans, fontSize: 11, letterSpacing: '0.18em',
          color: theme.textDim, textTransform: 'uppercase' }}>Daily average</div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 6 }}>
          ...
          <span style={{ ...TYPE.mono, fontSize: 11, color: theme.textMuted }}>
      ...
      <div style={{ padding: '20px 16px 0' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
          <Record theme={theme} label="Best day" value="14,820" sub="Saturday"
          ...
          <Record theme={theme} label="Active days" value="26/30" sub="86% consistency"
          ...
          {[
            ...
            <div key={i} style={{ marginBottom: i < 2 ? 14 : 0 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6,
                ...TYPE.sans, fontSize: 12, color: theme.text }}>
                <span>{r.label}</span>
                <span style={{ ...TYPE.mono, color: theme.textDim }}>
                  {r.mins} min · {Math.round(r.pct * 100)}%
                </span>
              </div>
              <div style={{ height: 5, background: theme.borderStrong, borderRadius: 3, overflow: 'hidden' }}>
                <div style={{ width: `${r.pct * 100}%`, height: '100%',
