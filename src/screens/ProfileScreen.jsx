...
import {
  IconArrowLeft, IconSettings, IconArrowRight, IconMore,
    ...
    <div style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ padding: '18px 18px 0' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
            <div style={{ border: `1px solid ${theme.border}`, borderRadius: 14, padding: 14, position: 'relative' }}>
          ...
          <button style={{
            width: '100%', marginTop: 16, padding: '14px 18px', borderRadius: 14,
            background: theme.accent, color: theme.bg, border: 'none',
            ...TYPE.sans, fontSize: 14, fontWeight: 600, letterSpacing: '0.06em', cursor: 'pointer',
          }}>
