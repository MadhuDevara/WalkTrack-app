      ...
      <div style={{ padding: '0 16px 8px' }}>
        <Card theme={theme} padding={16}>
          ...
          <div style={{ position: 'relative', height: 8 }}>
            ...
            <div style={{ position: 'absolute', left: 0, top: 0, height: 8, width: `${pct}%`, borderRadius: 4, background: theme.accent }} />
  ...
  return (
    <div>
      <svg viewBox={`0 0 ${w} ${h}`} width="100%" preserveAspectRatio="none" style={{ display: 'block' }}>
        ...
        <line x1={pad} x2={w - pad} y1={goalY} y2={goalY} stroke={theme.warm} strokeWidth="1" strokeDasharray="3 4" />
        <text x={w - pad} y={goalY - 4} textAnchor="end" fontSize="9" fill={theme.warm} fontFamily="JetBrains Mono">goal {goal}{u}</text>
